    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <?php foreach ($buku as $b) { ?>
                <form action="<?= base_url('buku/updateBuku'); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        if (isset($b['image'])) { ?>
                            ...
                            <picture>
                                ...
                                <img src="<?= base_url('assets/sbadmin/img/upload/') . $b['image']; ?>" class="rounded mx-auto mb-3 d-blok" alt="...">
                            </picture>
